      ...
      {section === "routes" && (
        <div>
          <div className="result-card" style={{ marginBottom: "20px" }}>
            ...
            {routesWithStatus.length === 0 ? <p style={{ color: "#dde0ff" }}>No route data. Click Refresh.</p> : filteredRoutes.length === 0 ? <p style={{ color: "#dde0ff" }}>No routes match your filters.</p> : (
